...
public class MusicNoteInterface implements Comparable<MusicNoteInterface> {
        ...
        private int freqInt = (int)frequency; //Turn frequency into an int so we can use in CompareTo
     ...
     */
    @Override
    public int compareTo(MusicNoteInterface o) {
        return this.freqInt.compareTo(o.freqInt);
    }
}
